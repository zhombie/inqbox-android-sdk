...
import kz.qbox.sdk.domain.model.webrtc.IceConnectionState
import kz.qbox.sdk.webrtc.audio.RTCAudioManager
import kz.qbox.sdk.webrtc.core.constraints.*
import kz.qbox.sdk.webrtc.core.model.Target
import kz.qbox.sdk.webrtc.core.processor.ProxyVideoSink
import kz.qbox.sdk.webrtc.core.ui.SurfaceViewRenderer
import kz.qbox.sdk.webrtc.logger.Logger
import kz.qbox.sdk.webrtc.mapper.*
import kz.qbox.sdk.webrtc.utils.*
import org.webrtc.*
...
//            addMandatoryConstraint(PeerConnectionConstraints.GOOG_CPU_OVERUSE_DETECTION, true)
    ...
    fun setLocalVideoScalingType(scalingType: kz.qbox.sdk.webrtc.core.model.ScalingType) {
        runOnUiThread {
    ...
    fun setRemoteVideoScalingType(scalingType: kz.qbox.sdk.webrtc.core.model.ScalingType) {
        runOnUiThread {
    ...
    fun addRemoteIceCandidate(iceCandidate: kz.qbox.sdk.domain.model.webrtc.IceCandidate) {
    ...
    fun setRemoteDescription(sessionDescription: kz.qbox.sdk.domain.model.webrtc.SessionDescription) {
...
//        executor.shutdown()
    ...
    interface Listener {
        fun onLocalSessionDescription(
            sessionDescription: kz.qbox.sdk.domain.model.webrtc.SessionDescription
        )

        fun onLocalIceCandidate(iceCandidate: kz.qbox.sdk.domain.model.webrtc.IceCandidate)
