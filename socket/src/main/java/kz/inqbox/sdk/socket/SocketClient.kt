...
import kz.inqbox.sdk.domain.model.content.ContentType
...
import kz.inqbox.sdk.socket.emitter.JSONArrayListener
import kz.inqbox.sdk.socket.emitter.JSONObjectListener
import kz.inqbox.sdk.socket.event.Event
import kz.inqbox.sdk.socket.listener.*
import kz.inqbox.sdk.socket.logger.Logger
import kz.inqbox.sdk.socket.model.*
...
class SocketClient private constructor() : SocketRepository {
    ...
    private val language: String
        get() {
            val language = kz.inqbox.sdk.socket.Socket.getLanguage()
            return language.key
        }
